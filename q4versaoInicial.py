...
if ((mesInicial or mesFinal) <= 0) or ((mesInicial or mesFinal) > 12):
    print('O mês inserido não existe. Coloque os meses entre 1 e 12.')

if ((diaInicial or diaFinal) <= 0) or ((diaInicial or diaFinal) > 31):
    print('Os dias inseridos não existem. Coloque os dias entre 0 e 31')

elif (0 < (diaInicial and diaFinal) > 32) and (0 < (mesInicial and mesFinal) > 13) :
